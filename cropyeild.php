...
<body>
    ...
    <div class="container">
            ...
            <tbody>
                <?php
                    if(($csvfile = fopen("datafile/Cropsyield.csv","r"))!= FALSE){
                        $itr =   0;
                        while (($csvdata = fgetcsv($csvfile,1000, ",")) != FALSE and $itr < 25){
        ...
        <p><a href ="cropyeild1.php" > see all </a></p>
        <p>Note: (1) Data for Foodgrain, Oilseed and Commercial Crops are as per Fourth Advance Estimate for 2015-16. <br>                                                  
        (2) Data for Horticulture crops are as per Final Estimate for 2014-15 and 3rd Advance Estimate for 2015-16 released by Horticulture Division, DAC&FW.<br></p>                                              
